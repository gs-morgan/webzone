$.getJSON('https://spreadsheets.google.com/feeds/list/1VLrVmcGS-zVXBNHa-9zUjZ1VD8h6nvwJa9snXBAhmvY/od6/public/values?alt=json', function(data) {
  ...
  $.each(data.feed.entry, function(i, entry) {
    ...
    $(".container").append(id + '<div class="progress-contain"><h1>' + name_build + '</h1><div class="progress-bar loading stripes"><span style="width: ' + prog_build + '%"></span><div class="progress-value">' + prog_build + '% (' + res_build + '/' + full_build + ')</div></div></div>');
  });
});
